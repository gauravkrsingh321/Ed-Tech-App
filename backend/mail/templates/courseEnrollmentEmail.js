...
<body>
    <div class="container">
      <a href="https://study-notion-edtech-project.vercel.app"><img class="logo" src=""
      alt="StudyNotion Logo"></a>
      <div class="message">Course Registration Confirmation</div>
      <div class="body">
         <p>Dear ${name},</p>
         <p>
           You have successfully registered for the course <span class="highlight">"${courseName}"</span>. We are excited to have you as a participant!</p>
         </p>
